      ...
      <div className="content">
        <div className="card">
          ...
          <Field
            ...
            hint="Shown under the headline on Articles cards. Write a fresh sentence, not the headline again (a repeat is hidden on the card). Left blank, the opening of the article is used."
          >
